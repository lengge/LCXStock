...
- (void)viewDidLoad
{
    ...
    [self.view setBackgroundColor:[UIColor colorWithRed:(46.0)/255.0f green:(49.0)/255.0f blue:(50.0)/255.0f alpha:1.0f]];
...
- (UIProgressView *)progressView
{
    if (_progressView == nil) {
        ...
        [_progressView setProgressTintColor:[UIColor colorWithRed:(2.0)/255.0f green:(187.0)/255.0f blue:(0.0)/255.0f alpha:1.0f]];
...
{
    if (_authLabel == nil) {
        _authLabel = [[UILabel alloc] initWithFrame:CGRectMake(20, 0 + 13, SCREEN_WIDTH - 40, 0)];
